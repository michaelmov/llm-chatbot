    ...
    React.useEffect(() => {
      const adjustPadding = () => {
        if (textareaRef.current && toolbarRef.current) {
          textareaRef.current.style.paddingBottom = `${toolbarRef.current.offsetHeight + 8}px`;
        }
      };
                        ...
                        <DropdownMenuTrigger asChild disabled={isLoading}>
                          ...
                          >
                            ...
                            <span className="hidden sm:inline">
                              {tool.options?.find((opt) => opt.value === tool.value)?.label ||
                                tool.label}
                            </span>
                          ...
                          {tool.options?.map((option) => (
                            <DropdownMenuItem
                              ...
                              className={cn(
                                ...
                                tool.value === option.value && 'bg-muted font-medium'
                              )}
                              onClick={() => {
